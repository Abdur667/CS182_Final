...
class CatanLog(object):
    ...
    def log_moves_robber_and_steals(self, player, location, victim):
        """
        :param player: catan.game.Player
    ...
    def log_buys_road(self, player, location):
        """
        :param player: catan.game.Player
        :param location: string, see hexgrid.location()
        """
    ...
    def log_buys_settlement(self, player, location):
        """
        :param player: catan.game.Player
        :param location: string, see hexgrid.location()
        """
    ...
    def log_buys_city(self, player, location):
        """
        :param player: catan.game.Player
        :param location: string, see hexgrid.location()
        """
    ...
    def log_buys_dev_card(self, player):
        """
        :param player: catan.game.Player
        """
    ...
    def log_trades_with_port(self, player, to_port, port, to_player):
        """
        :param player: catan.game.Player
    ...
    def log_trades_with_other_player(self, player, to_other, other, to_player):
        """
        :param player: catan.game.Player
    ...
    def log_plays_knight(self, player, location, victim):
        """
        :param player: catan.game.Player
        :param location: string, see hexgrid.location()
        :param victim: catan.game.Player
        ...
        self.log_moves_robber_and_steals(player, location, victim)

    def log_plays_road_builder(self, player, location1, location2):
        """
        :param player: catan.game.Player
    ...
    def log_plays_year_of_plenty(self, player, resource1, resource2):
        """
        :param player: catan.game.Player
    ...
    def log_plays_monopoly(self, player, resource):
        """
        :param player: catan.game.Player
    ...
    def log_plays_victory_point(self, player):
        """
        :param player: catan.game.Player
        """
        self._logln('{0} plays victory point'.format(player.color))

    def log_ends_turn(self, player):
        """
        :param player: catan.game.Player
        """
